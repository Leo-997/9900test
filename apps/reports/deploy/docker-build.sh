...
export WORKSPACE=apps/reports
export IMAGE_NAME=$BASE_IMAGE_NAME:reports_$IMAGE_TAG
export LATEST_IMAGE_NAME=$BASE_IMAGE_NAME:reports_${ENVIRONMENT}_latest
