...
export WORKSPACE=apps/api
export IMAGE_NAME=$BASE_IMAGE_NAME:api_$IMAGE_TAG
export LATEST_IMAGE_NAME=$BASE_IMAGE_NAME:api_${ENVIRONMENT}_latest
export KUBE_DEPLOYMENT_NAME=zerodashapi
