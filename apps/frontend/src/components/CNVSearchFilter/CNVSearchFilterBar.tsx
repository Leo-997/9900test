...
import { cnvSortMenuOptions } from '../../constants/Curation/cnv';
...
export default function CNVSearchFilterBar({
  toggled,
  emptyOptions,
  defaultOptions,
  setToggled,
  ...
  return (
    ...
    >
      ...
      <SortButton
        toggled={toggled}
        setToggled={setToggled}
        sortOptions={cnvSortMenuOptions}
        disabled={disabled}
      />
      <QuickFilters
