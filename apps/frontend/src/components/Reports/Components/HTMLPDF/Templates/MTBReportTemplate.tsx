...
interface IMTBReportTemplateProps {
  logoDataUri: string;
  context?: IReportContext;
  demographics?: IPatientDemographics | null;
}

export function MTBReportTemplate({
  logoDataUri,
  context,
  demographics,
}: IMTBReportTemplateProps): JSX.Element {
  return (
    <TemplateRoot>
      <HeaderBox>
        <Box display="flex" flexDirection="row" alignItems="center" width="100%">
          ...
          <Box display="flex" flexDirection="column" alignItems="center" width="100%">
            <CustomTypography variant="titleRegular" fontSize="24px" fontWeight="bold">
              <span>Multidisciplinary Tumour Board Report</span>
            </CustomTypography>
      ...
      <FooterBox>
        ...
        <FooterRight>
          <CustomTypography variant="label" style={{ color: '#022034', fontSize: '8px' }}>
            ZERO2 CLINICAL RESEARCH REPORT V3.2 RELEASED JANUARY 2026
          </CustomTypography>
          <CustomTypography variant="label" style={{ color: '#022034', fontSize: '8px' }}>
            &nbsp;
          </CustomTypography>
