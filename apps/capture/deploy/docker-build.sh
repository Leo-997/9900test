...
export WORKSPACE=apps/capture
export IMAGE_NAME=$BASE_IMAGE_NAME:capture_$IMAGE_TAG
export LATEST_IMAGE_NAME=$BASE_IMAGE_NAME:capture_${ENVIRONMENT}_latest
